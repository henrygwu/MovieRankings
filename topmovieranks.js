...
//authentication for sender email and password from JSON file
...
//if statement if no artist specified in argument
    if (argArray.length < 1) {
        console.log('You did not specify a movie');
        return;
    }

//if statement if no artist found in top 25 list
    if (intersection == '') {
